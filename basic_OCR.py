...
'''
Storing the extracted details in the format of json, excel, csv and Database
'''
...
def result_data(file):
    ...
    df=df.fillna(' ')
    save_file = open("output_file1.json", "a")  
